...
public class UserDAO {
    ...
    public boolean addUser(String username, String password, String email) {
        ...
        DBObject add = new BasicDBObject("_id",username).append("password",passwordHash);
    ...
    public DBObject validateLogin(String username, String password) {
        ...
        QueryBuilder builder = QueryBuilder.start("_id").is(username).and("password").is(password);
